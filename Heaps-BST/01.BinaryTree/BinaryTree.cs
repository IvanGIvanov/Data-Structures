namespace _01.BinaryTree
{
    ...
    public class BinaryTree<T> : IAbstractBinaryTree<T>
    {
        ...
        private void DfsPreOrder(StringBuilder sb, int indent, IAbstractBinaryTree<T> binaryTree)
        {
            ...
            {
                this.DfsPreOrder(sb, indent + 2, binaryTree.LeftChild);
            }
            if (binaryTree.RightChild != null)
            {
                this.DfsPreOrder(sb, indent + 2, binaryTree.RightChild);
            }
        }
